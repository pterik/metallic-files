object FormEnterUser: TFormEnterUser
  ...
  object QUsers2: TZQuery
    Connection = FormMain.ZC2
    SQL.Strings = (
      'SELECT * FROM USERS'
      'WHERE U_ISCLOSED=0'
      'AND U_LOGIN=:U_LOGIN'
    ...
    object QUsers2U_ID: TIntegerField
      FieldName = 'U_ID'
      Required = True
    end
    object QUsers2U_LOGIN: TStringField
      FieldName = 'U_LOGIN'
      Size = 30
    end
    object QUsers2U_PASSWORD: TStringField
      FieldName = 'U_PASSWORD'
      Size = 10
    end
    object QUsers2U_ISBOSS: TIntegerField
      FieldName = 'U_ISBOSS'
    end
    object QUsers2U_FIO: TStringField
      FieldName = 'U_FIO'
      Size = 50
    end
    object QUsers2U_COMMENT: TStringField
      FieldName = 'U_COMMENT'
      Size = 50
    end
    object QUsers2U_EDIT_OWN_JOBS: TSmallintField
      FieldName = 'U_EDIT_OWN_JOBS'
      Required = True
    end
    object QUsers2U_EDIT_PRICES: TSmallintField
      FieldName = 'U_EDIT_PRICES'
      Required = True
    end
    object QUsers2U_ISCLOSED: TSmallintField
